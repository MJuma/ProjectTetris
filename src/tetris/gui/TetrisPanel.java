...
public class TetrisPanel extends JPanel implements Observer
{
  ...
  /**
   * Flag for determining if the game has
   * started.
   */
  private boolean my_has_started;
   ...
   */
  public TetrisPanel(final TetrisGui the_frame, final Board the_board)
  {
    super();
  ...
  /**
   * Returns a boolean if the user is
   * currently playing a game.
   * @return my_in_game
   */
  public boolean hasStarted()
  {
    return my_has_started;
  }
  ...
  public void newGame()
  {
    my_timer.setDelay(DEFAULT_DELAY);
    my_game_ended = false;
    my_has_started = true;
  ...
  private void showGameOverText(final Graphics2D the_g2d, final int the_height)
  {
    ...
    the_g2d.setFont(new Font(DEFAULT_FONT, Font.BOLD, DEFAULT_FONT_SIZE));
    the_g2d.drawString("Game Over", 0, the_height / 2);
  }
