...
{ 
  ...
  {
    my_tetromino = new Tetromino[] {new Tetromino(5, 5, Tetrominos.I.getTetromino(), null),
      new Tetromino(5, 5, Tetrominos.J.getTetromino(), null),
      new Tetromino(5, 5, Tetrominos.L.getTetromino(), null),
      new Tetromino(5, 5, Tetrominos.S.getTetromino(), null),
      new Tetromino(5, 5, Tetrominos.Z.getTetromino(), null),
      new Tetromino(5, 5, Tetrominos.O.getTetromino(), null),
      new Tetromino(5, 5, Tetrominos.T.getTetromino(), null)};
  }
  ...
  {
    final Tetromino rotated_once = new
        Tetromino(5, 5, new int[][] {{0, 0, 0}, {1, 2, 3}, {0, 0, 4}}, null);
    final Tetromino rotated_twice = new
        Tetromino(5, 5, new int[][] {{0, 3, 4}, {0, 2, 0}, {0, 1, 0}}, null);
    final Tetromino rotated_thrice = new
        Tetromino(5, 5, new int[][] {{4, 0, 0}, {3, 2, 1}, {0, 0, 0}}, null);
  ...
  {
    final Tetromino rotated_once = new
        Tetromino(5, 5, new int[][] {{0, 0, 4}, {1, 2, 3}, {0, 0, 0}}, null);
    final Tetromino rotated_twice = new
        Tetromino(5, 5, new int[][] {{4, 3, 0}, {0, 2, 0}, {0, 1, 0}}, null);
    final Tetromino rotated_thrice = new
        Tetromino(5, 5, new int[][] {{0, 0, 0}, {3, 2, 1}, {4, 0, 0}}, null);
  ...
  {
    final Tetromino rotated_once = new
        Tetromino(5, 5, new int[][] {{1, 0, 0}, {2, 3, 0}, {0, 4, 0}}, null);
    final Tetromino rotated_twice = new
        Tetromino(5, 5, new int[][] {{0, 0, 0}, {0, 3, 4}, {1, 2, 0}}, null);
    final Tetromino rotated_thrice = new
        Tetromino(5, 5, new int[][] {{0, 4, 0}, {0, 3, 2}, {0, 0, 1}}, null);
  ...
  {
    final Tetromino rotated_once = new
        Tetromino(5, 5, new int[][] {{0, 4, 0}, {2, 3, 0}, {1, 0, 0}}, null);
    final Tetromino rotated_twice = new
        Tetromino(5, 5, new int[][] {{0, 0, 0}, {4, 3, 0}, {0, 2, 1}}, null);
    final Tetromino rotated_thrice = new
        Tetromino(5, 5, new int[][] {{0, 0, 1}, {0, 3, 2}, {0, 4, 0}}, null);
  ...
  {
    final Tetromino rotated_once = new
        Tetromino(5, 5, new int[][] {{2, 4}, {1, 3}}, null);
    final Tetromino rotated_twice = new
        Tetromino(5, 5, new int[][] {{4, 3}, {2, 1}}, null);
    final Tetromino rotated_thrice = new
        Tetromino(5, 5, new int[][] {{3, 1}, {4, 2}}, null);
  ...
  {
    final Tetromino rotated_once = new
        Tetromino(5, 5, new int[][] {{0, 0, 4}, {0, 1, 3}, {0, 0, 2}}, null);
    final Tetromino rotated_twice = new
        Tetromino(5, 5, new int[][] {{4, 3, 2}, {0, 1, 0}, {0, 0, 0}}, null);
    final Tetromino rotated_thrice = new
        Tetromino(5, 5, new int[][] {{2, 0, 0}, {3, 1, 0}, {4, 0, 0}}, null);
  ...
  /**
   * Tests the color for the I Tetromino.
   */
  @Test
  public void colorTestI()
  {
    assertEquals("Tetromino I is Cyan.", Tetrominos.I.getColor(), Color.CYAN);
  }
  
  /**
   * Tests the color for the L Tetromino.
   */
  @Test
  public void colorTestL()
  {
    assertEquals("Tetromino L is Orange.", Tetrominos.L.getColor(), Color.ORANGE);
  }
  
  /**
   * Tests the color for the J Tetromino.
   */
  @Test
  public void colorTestJ()
  {
    assertEquals("Tetromino J is Blue.", Tetrominos.J.getColor(), Color.BLUE);
  }
  
  /**
   * Tests the color for the S Tetromino.
   */
  @Test
  public void colorTestS()
  {
    assertEquals("Tetromino S is Green.", Tetrominos.S.getColor(), Color.GREEN);
  }
  
  /**
   * Tests the color for the Z Tetromino.
   */
  @Test
  public void colorTestZ()
  {
    assertEquals("Tetromino Z is Red.", Tetrominos.Z.getColor(), Color.RED);
  }
  
  /**
   * Tests the color for the T Tetromino.
   */
  @Test
  public void colorTestT()
  {
    assertEquals("Tetromino T is Magenta.", Tetrominos.T.getColor(), Color.MAGENTA);
  }
  
  /**
   * Tests the color for the O Tetromino.
   */
  @Test
  public void colorTestO()
  {
    assertEquals("Tetromino O is Yellow.", Tetrominos.O.getColor(), Color.YELLOW);
  }
}